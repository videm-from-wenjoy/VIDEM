		...
		do {
			...
			switch(opcIni) {
				...
				case 2:
					...
					bbdd.a�adir_Cliente(cl);
					if ( bbdd.a�adir_Cliente(cl)) {
			...
			if(opc2.equalsIgnoreCase("ADMINISTRADOR")) {
				do {
					...
					case 1:
						...
						bbdd.a�adir_Empleado(emp);
						if ( bbdd.a�adir_Empleado(emp)) {
				...
				switch(opc3) {
					...
					case 2:
						...
						do {
							...
							String plataforma=sc.nextLine();
							System.out.println("Selecciona el n�mero de unidades");
							int unidades=sc.nextInt();							
						    ...
						    sc.nextLine();
							System.out.println("�Desea comprar algun objeto m�s?");
							res=sc.nextLine();
